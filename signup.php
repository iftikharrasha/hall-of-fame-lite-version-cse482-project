...
<div class="contents">
  <div class="body-content">
    <div class="body-alumni-left">
      <p class="blog align8">SIGNUP FORM
      </p>
      ...
      <div class="register">
        <form action="signup.php?submitted" method="POST">
          <label class="admin-label al1" for="fname">FULL NAME
          </label>
          <br>
          <input class="field f3" type="text" name="fname" value="">
          <br>
          <label class="admin-label al2" for="lname">USERNAME
          </label>
          <br>
          <input class="field f4" type="text" name="uname" value="">
          <br>
          <label class="admin-label al3" for="fname">PASSWORD
          </label>
          <br>
          <input class="field f5" type="password" name="pass" value="">
          <br>
          <label class="admin-label al6" for="fname">EMAIL
          </label>
          <br>
          <input class="field f55" type="email" name="email" value="">
          <br>
          <label class="admin-label al7" for="fname">PHONE
          </label>
          <br>
          <input class="field f65" type="text" name="phone" value="">
          <br>
    ...
    <div class="body-alumni-right">
      <p class="blog align8">Instructions
      </p>
      <div class="instructions">
        <img class="badge" src="./images/logo.png" alt="">
        <p class="info info-10">Before you proceed
        </p>
        ...
        <p class="info info-12">If you already have your login details then please go to the login page and
          after logged in you can post and see your details.
        </p>
        <p class="info info-13">For any further query please contact:
        </p>
        <p class="info info-14">+880 2 55668200
        </p>
        <p class="info info-15">nsu.halloffame@info.com
        </p>
      </div>
    </div>
  </div>
