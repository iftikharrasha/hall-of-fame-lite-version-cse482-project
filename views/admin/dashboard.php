<?php
	...
	//total post counts
	$countUsers= mysqli_query($con, "SELECT COUNT(id) as TOTAL FROM user");
	$totalUsers = mysqli_fetch_assoc($countUsers);
	...
	//total Mail counts
	$countMails= mysqli_query($con, "SELECT COUNT(contact_id) as TOTAL FROM contact");
	$totalMails = mysqli_fetch_assoc($countMails);
    ...
    <div class="body-content">
      ...
      <div class="body-right">
        <div class="body-adright-1">
          <div class="blog-content stat1 child">
            <p class="top-blog">Posts
            </p>
            <span>
              <?php echo $totalPosts['TOTAL']; ?>
            </span>
          </div>
          <div class="blog-content stat2 child">
            <p class="top-blog">Pending
            </p>
            <span>17
            </span>
          </div>
          <div class="blog-content stat3 child">
            <p class="top-blog">Approved
            </p>
            <span>58
            </span>
          </div>
          <div class="blog-content stat4 child">
            <p class="top-blog">Rejected
            </p>
            <span>12
            </span>
          </div>
          <div class="blog-content stat5 child">
            <p class="top-blog">Users
            </p>
            <span><?php echo $totalUsers['TOTAL']; ?>
            </span>
          </div>
          <div class="blog-content stat6 child">
            <p class="top-blog">Categories
            </p>
            <span>
              <?php echo $totalCategories['TOTAL']; ?>
            </span>
          </div>
          <div class="blog-content stat7 child">
            <p class="top-blog">Mails
            </p>
            <span><?php echo $totalMails['TOTAL']; ?>
            </span>
          </div>
          <div class="blog-content stat8 child">
            <p class="top-blog">Admins
            </p>
            <span>
          ...
          <div class="calendar">
            <div class="month">
              <ul>
                <li>September
                  <br>
                  <span style="font-size:18px">2020
                  </span>
                </li>
              </ul>
            </div>
