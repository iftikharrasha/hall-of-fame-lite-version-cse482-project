            ...
            <ul class="nav1 side-menu">
              ...
              <li class="active">
                ...
                <ul class="nav child_menu" style="display: block;">
                  ...
                  <li style="background-color: #5a728b;"><a href="../post/newpost.php">New Post</a></li>
                </ul>
              </li>
      ...
      <div class="body-right">
        ...
        <div class="register">
          ...
          <form action="newpost.php" method="POST" enctype="multipart/form-data">
            ...
            <input class="field f3" type="text" id="fname" name="post-title"><br>
            ...
            <label class="admin-label al5" for="post-image">Feature Image</label><br>
            <input class="field f7" id="fname" type="File" name="post-image"><br>
            <label class="admin-label al6" for="lname">Description</label><br>
            <textarea class="field f8" id="w3review" name="post-content" rows="10">
            </textarea>
            <button name="post-submit" class="submit s3" ">Publish</button>
