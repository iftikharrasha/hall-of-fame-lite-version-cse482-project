          ...
          <div class="row">
            <div class="col-12">
              <div class="blog-content">
                <a href="blog.php?category=<?php echo $category['cat_name'] ?>" class="top-blog">
...
<?php
	...
	if ( isset($_GET['search'])) {
			$search = $_GET['search'];
			$query = "SELECT * FROM post WHERE post_date_time LIKE '%$search%' OR title LIKE '%$search%' OR category LIKE '$search%' OR author LIKE '$search%' OR post LIKE '$search%' LIMIT 6";
	}else if ( isset($_GET['category'])) {
		$query = "SELECT * FROM post WHERE category = '$_GET[category]' LIMIT 6";
...
?>
          <div class="col-lg-<?php echo $bootstrapColWidth; ?>">
            <div class="blog-1">
              <p class="top-blog">
                <?php echo htmlentities($post_title); ?>
              </p>
              <p class="about about3">
                <?php echo htmlentities($post_content); ?>
              </p>
              <div class="views">
                <p class="vp1">
                  <?php echo htmlentities($views); ?>
                <p>
                <p class="vp2">views
                <p>
              </div>
              <a href="seepost.php?id=<?php echo $post_id;?>" class="read read-2">Read More
              </a>
            </div>
          </div>
<?php
...
?>
                <li class="active">
                  <a href="blog.php?page=<?php echo $count ?>">
                    <?php echo $count ?>
                  </a>
                </li>
<?php
