      ...
      <div class="body-left">
        <div class="body-left-1">
			...
			<div class="row">
				<div class="col-12">
					<div class="blog-content nc1">
						<a href="seepost.php?id=<?php echo $post_id;?>" class="top-blog"><?php echo $post_title; ?>
						</a>
						<span>
						  <i class="fa fa-calendar" aria-hidden="true">
						  </i> <?php echo htmlentities($post_date); ?>
						</span>
				  </div>
				</div>
			</div>
          ...
          <div class="nc-view nc-v-1">
            <i class="fa fa-angle-right angle-right" aria-hidden="true">
            </i>
            <i class="fa fa-angle-left angle-left" aria-hidden="true">
            </i>
      ...
      <div class="body-right">
        ...
        <div class="body-right-2">
          <div class="founded">
            ...
            <a href="" class="read read-1">Read More
            </a>
          </div>
        </div>
      </div>
